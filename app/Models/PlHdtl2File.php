...
class PlHdtl2File extends Model
{
    use HasFactory;
    ...
    {
        $types = [
            'kq_thi_tn_hang_ngay' => 'KQ thi TN (hàng ngày)',
            'kq_thi_tn_dieu_chinh' => 'KQ thi TN (Điều chỉnh)',
            'kq_tot_nghiep' => 'KQ tốt nghiệp',
            'ds_hoc_vien_tn_gioi' => 'DS Học Viên TN Giỏi',
            'ds_hoc_vien_khen_thuong' => 'DS học viên khen thưởng'
        ];
