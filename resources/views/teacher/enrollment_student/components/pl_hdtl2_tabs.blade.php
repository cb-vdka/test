...
<div class="tab-content" id="plHdtl2TabsContent">
    <div class="tab-pane fade show active" id="kq-thi-tn-hang-ngay" role="tabpanel" aria-labelledby="kq-thi-tn-hang-ngay-tab">
        @include('teacher.enrollment_student.components.pl_hdtl2_table_content', ['fileType' => 'kq_thi_tn_hang_ngay', 'title' => 'KQ thi TN (hàng ngày)'])
    </div>
    <div class="tab-pane fade" id="kq-thi-tn-dieu-chinh" role="tabpanel" aria-labelledby="kq-thi-tn-dieu-chinh-tab">
        @include('teacher.enrollment_student.components.pl_hdtl2_table_content', ['fileType' => 'kq_thi_tn_dieu_chinh', 'title' => 'KQ thi TN (Điều chỉnh)'])
    </div>
    <div class="tab-pane fade" id="kq-tot-nghiep" role="tabpanel" aria-labelledby="kq-tot-nghiep-tab">
        @include('teacher.enrollment_student.components.pl_hdtl2_table_content', ['fileType' => 'kq_tot_nghiep', 'title' => 'KQ tốt nghiệp'])
    </div>
    <div class="tab-pane fade" id="ds-hoc-vien-tn-gioi" role="tabpanel" aria-labelledby="ds-hoc-vien-tn-gioi-tab">
        @include('teacher.enrollment_student.components.pl_hdtl2_table_content', ['fileType' => 'ds_hoc_vien_tn_gioi', 'title' => 'DS Học Viên TN Giỏi'])
    </div>
    <div class="tab-pane fade" id="ds-hoc-vien-khen-thuong" role="tabpanel" aria-labelledby="ds-hoc-vien-khen-thuong-tab">
        @include('teacher.enrollment_student.components.pl_hdtl2_table_content', ['fileType' => 'ds_hoc_vien_khen_thuong', 'title' => 'DS học viên khen thưởng'])
    </div>
</div>

@include('teacher.enrollment_student.components.pl_hdtl2_modals')
