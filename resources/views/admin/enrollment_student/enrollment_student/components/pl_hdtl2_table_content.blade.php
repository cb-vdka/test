<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#uploadPlHdtl2Modal" onclick="setFileType('{{ $fileType }}', '{{ $title }}')">
                    ...
                    <tr class="align-middle">
                        ...
                        <td class="py-3">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="/wp-admin/enrollment_student/download-pl-hdtl2-file/{{ $file->id }}" class="btn btn-outline-success btn-sm" title="Tải xuống">
                ...
                <tr>
                    <td colspan="5" class="text-center py-5">
                        <div class="text-muted">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#uploadPlHdtl2Modal" onclick="setFileType('{{ $fileType }}', '{{ $title }}')">
    ...
    <div class="card-footer bg-light border-top">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="btn-group btn-group-sm">
                ...
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#uploadPlHdtl2Modal" onclick="setFileType('{{ $fileType }}', '{{ $title }}')" title="Thêm mới">
