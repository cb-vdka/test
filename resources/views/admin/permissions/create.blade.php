...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Tạo Quyền hạn mới</h4>
                            ...
                            <form action="{{ route('admin.permissions.store') }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted">
                                                Tên quyền phải là duy nhất và theo định dạng: module.action (ví dụ: user.create, post.edit)
                                            </small>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-save"></i> Tạo quyền hạn
                                    </button>
