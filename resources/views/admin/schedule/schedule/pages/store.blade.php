<div class="page-inner">
    ...
    @php
        $url = $config['method'] == 'create' ? route('schedule.store') : route('schedule.update', $schedule->id);
        $title = $config['method'] == 'create' ? 'Thêm mới lịch huấn luyện' : 'Chỉnh sửa lịch huấn luyện';
    @endphp
