...
<div class="sidebar" data-background-color="dark">
        ...
        <div class="logo-header" data-background-color="dark">
            @if (!empty(session('user_role') == 1))
                <a href="{{ route('dashboard.index') }}" class="logo">
                    <img src="{{ asset(env('LOGO', 'default/logo/logo.png')) }}" alt="Logo" height="45">
                </a>
            ...
            <div class="nav-toggle d-flex d-lg-none">
                <button class="btn btn-toggle" type="button" data-bs-toggle="collapse" data-bs-target="#adminSidebarMenu" aria-controls="adminSidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner scroll-y-hidden">
        <div class="sidebar-content collapse d-lg-block" id="adminSidebarMenu">
